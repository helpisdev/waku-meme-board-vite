...
export function Node({ id, status, network }: Props): React.ReactNode {
  return (
    <div className="px-6 py-4 min-w-2/4 rounded-lg border-2 border-subtle-borders-and-seperators bg-ui-el shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:border-subtle-borders-and-seperators-dark dark:bg-ui-el-dark">
      {network && (
